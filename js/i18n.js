...
(function (global) {
  const STRINGS = {
    es: {
      ...
      auto_area: 'Auto = suma de los sectores',
      area_only: 'Solo tengo el área (sin largo y ancho)',
      sector: 'Sector',
      add_sector: '+ Agregar sector',
      remove_sector: 'Quitar sector',
      ...
      copied: 'Listo',
      sign_hint_digital: '✍️ Firma del cliente con el dedo',
      sign_hint_physical: '🖨️ El cliente firmará en papel (CEO ya firmado)',
      clear_cust: 'Borrar firma',
      ...
      search_quotes: 'Buscar por nombre o dirección…',
      ...
      confirm_reset: '¿Limpiar el formulario? Se perderán los datos que no hayas guardado.',
      ...
      sync_hold_hint: 'Triple clic para actualizar el sistema',
      ...
      sign_link_msg: 'Sign your invoice here:',
      ...
      sign_hint: 'Sign with your finger below',
      sign_clear: 'Clear signature',
      sign_submit: 'Sign and send',
      sign_thanks: 'Thank you. Your signature was sent.',
      sign_invalid: 'Invalid or expired link.',
      sign_already: 'This invoice has already been signed. Thank you.',
      ...
      restore_step: 'Importar respaldo ({n} de 3)',
      confirm_restore_2: '¿Estás seguro? Las cotizaciones, trabajos e invoices actuales se reemplazarán.\n\nEl respaldo trae {q} cotizaciones, {j} trabajos y {i} invoices.',
      confirm_restore_3: 'Última confirmación. Esta acción no se puede deshacer.',
      import_phrase: 'IMPORTAR',
      import_phrase_hint: 'Para importar, escribe exactamente: {phrase}',
      continue: 'Continuar',
    ...
    en: {
      ...
      auto_area: 'Auto = sum of all sections',
      area_only: 'I only have the area (no length/width)',
      sector: 'Section',
      add_sector: '+ Add section',
      remove_sector: 'Remove section',
      ...
      copied: 'Done',
      sign_hint_digital: '✍️ Customer signs with a finger',
      sign_hint_physical: '🖨️ Customer will sign on paper (CEO already signed)',
      clear_cust: 'Clear signature',
      clear_ceo: 'Clear CEO',
      new_invoice: 'New',
      cancel: 'Cancel',
      ...
      search_quotes: 'Search by name or address…',
      ...
      confirm_reset: 'Clear the form? Any unsaved data will be lost.',
      ...
      sync_now: 'Sync all',
      sync_hold_hint: 'Triple-click to update the app',
      ...
      restore_step: 'Import backup ({n} of 3)',
      confirm_restore_2: 'Are you sure? Current quotes, jobs and invoices will be replaced.\n\nThe backup has {q} quotes, {j} jobs and {i} invoices.',
      confirm_restore_3: 'Final confirmation. This cannot be undone.',
      import_phrase: 'IMPORT',
      import_phrase_hint: 'To import, type exactly: {phrase}',
      continue: 'Continue',
