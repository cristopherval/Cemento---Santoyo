...
(function (global) {
  const STRINGS = {
    es: {
      ...
      storage_hint: 'Sube y guarda PDFs (invoices, recibos) en la nube.',
      upload_pdf: 'Subir PDF',
      uploading: 'Subiendo…',
      upload_done: 'Archivo subido',
      no_files: 'Aún no hay archivos.',
      confirm_del_file: '¿Eliminar este archivo?',
      storage_need_cloud: 'Inicia sesión para usar el almacenamiento.',
      storage_offline: 'Necesitas conexión para subir o ver archivos.',
    ...
    en: {
      ...
      storage_hint: 'Upload and keep PDFs (invoices, receipts) in the cloud.',
      upload_pdf: 'Upload PDF',
      uploading: 'Uploading…',
      upload_done: 'File uploaded',
      no_files: 'No files yet.',
      confirm_del_file: 'Delete this file?',
      storage_need_cloud: 'Sign in to use storage.',
      storage_offline: 'You need a connection to upload or view files.',
